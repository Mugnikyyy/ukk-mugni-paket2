...
Route::middleware(['isMasyarakat'])->group(function () {
    Route::get('/dashboard-me', [UserController::class, 'dashboard'])->name('dashboard.masyarakat');

    Route::get('/tambah-pengaduan', [UserController::class, 'tambahPengaduanView'])->name('pemas.tambah-pengaduan');    
...
Route::middleware(['guest'])->group(function () {
    ...
    // Login
    Route::get('/login/auth', [UserController::class, 'loginView'])->name('pemas.loginView');
