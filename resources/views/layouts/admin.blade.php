                    ...
                    <ul id="sidebarnav">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="#" class="" id="Userdd" role="button"
                                        ...
                                        <h5 class="m-b-0 user-name font-medium">
                                            {{ Auth::guard('admin')->user()->nama_petugas }} <i
                                                class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email">{{ Auth::guard('admin')->user()->level }}</span>
                                    </a>
                        ...
                        @if (Auth::guard('admin')->user()->level == 'admin')
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/dashboard') ? 'active' : '' }}"
                                    href="{{ route('dashboard.index') }}">Dashboard</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/verifikasi-pengaduan') ? 'active' : '' }}"
                                    href="{{ route('verifikasi-pengaduan.index') }}">Pengaduan Belum Verifikasi</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/pengaduan') ? 'active' : '' }}"
                                    href="{{ route('pengaduan.index') }}">Pengaduan</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/petugas') ? 'active' : '' }}"
                                    href="{{ route('petugas.index') }}">Petugas</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/masyarakat') ? 'active' : '' }}"
                                    href="{{ route('masyarakat.index') }}">Masyarakat</a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark {{ Request::is('admin/laporan') ? 'active' : '' }}"
                        ...
                        @endif
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark" href="{{ route('admin.logout') }}">Keluar</a>
                        </li>
                    </ul>
