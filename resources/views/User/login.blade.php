                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('pemas.login') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary mb-3 text-white mt-3" style="width: 100%">MASUK</button>
                                    <a href="{{ route('pemas.index') }}" class="btn btn-warning text-white mb-3" style="width: 100%">Kembali ke
                                      Halaman Utama</a>
                                </form>
                                <a href="{{ route('pemas.formRegister') }}">Belum Punya Akun?</a>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
