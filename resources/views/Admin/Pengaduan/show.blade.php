                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th>Foto</th>
                            <td>:</td>
                            <td><img src="{{ url($pengaduan->foto) }}" alt="Foto Pengaduan" class="embed-responsive img-fluid"></td>
                        </tr>
                        <tr>
                            <th>Isi Laporan</th>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="" class="label label-danger">Belum Dikonfirmasi</a>
                                @elseif($pengaduan->akses == 'terbatas')
                                <a href="" class="label label-warning text-white">Terbatas</a>
                                @else
            ...
            <div class="card-body">
                <form action="{{ route('tanggapan.createOrUpdate') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <select name="akses" id="akses" class="custom-select form-control">
                                @if ($pengaduan->akses == '0')
